    ...
    <div class="body-width"> 
      ...
      <div class="body-content">
        ...
        <div id="jmreport-page">
          ...
          <div>
            <form action="<?php echo base_url('index.php/admin/template/template_edit'); ?>" method="post">
                <table>
                    <input type="hidden" name="id" value="<?php echo $template_info['id']; ?>">

                    <tr>
                        <td>名称：<input type="text" name="templatename" value="<?php echo $template_info['templatename']; ?>" /></td>
                    </tr>
                    <tr>
                     <td>内容：<textarea name="content" style="width:400px;height:150px;"><?php echo $template_info['content']; ?></textarea></td>
                    </tr>
                    <tr>
                        <td colspan=2>
                            <input type="submit" />
