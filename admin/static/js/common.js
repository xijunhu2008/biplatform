...
function isNetNumber(type) {
    if (type.toLowerCase().indexOf('sbyte') ||
    type.toLowerCase().indexOf('byte') ||
    type.toLowerCase().indexOf('short') ||
    type.toLowerCase().indexOf('ushort') ||
    type.toLowerCase().indexOf('int') ||
    type.toLowerCase().indexOf('uint') ||
    type.toLowerCase().indexOf('long') ||
    type.toLowerCase().indexOf('ulong') ||
    type.toLowerCase().indexOf('float') ||
    type.toLowerCase().indexOf('double') ||
    type.toLowerCase().indexOf('decimal')) {
        return true;
    }
