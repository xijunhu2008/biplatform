<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="page.aspx.cs" Inherits="JM.Report.Web.report.page" %>
...
<meta name="force-rendering" content="webkit">
    ...
    <link rel="stylesheet" type="text/css" href="../static/js/jquery-ui/css/cupertino/jquery-ui-1.10.3.custom.min.css">
    <%--<link rel="stylesheet" type="text/css" href="../static/js/jquery-ui/css/cupertino/jmreport-jquery-ui.css">--%>
    ...
    <script type="text/javascript" src="../static/js/jquery-ui/js/jquery-ui-timepicker-addon.js"></script>
    <script type="text/javascript" src="../static/js/jquery-ui/js/jquery-ui-timepicker-zh-CN.js"></script>
    ...
    <script type="text/javascript" src="../static/js//highcharts/modules/funnel.js"></script>
    <script type="text/javascript" src="../static/js//highcharts/modules/exporting.src.js"></script>

    <!--epr控件Base-->
    <script type="text/javascript" src="../static/js//common.js"></script>
    <script type="text/javascript" src="../static/js/report/jmreport.js"></script>
    <script type="text/javascript" src="../static/js/report/jmreport.poppage.js"></script>
  <%--  <script type="text/javascript" src="../static/js/report/jmreport.mail.js"></script>
    <script type="text/javascript" src="../static/js/report/jmreport.notice.js"></script>--%>
    <script type="text/javascript" src="../static/js/report/jmreport.lan.js"></script>
    <script type="text/javascript" src="../static/js/report/jmreport.serverProxy.js"></script>

    <!--epr工具栏控件-->
    <script type="text/javascript" src="../static/js/report/jmreport.toolbarControls.js"></script>
    <script type="text/javascript" src="../static/js/report/toolbarcontrols/checkBoxList.js"></script>
    <script type="text/javascript" src="../static/js/report/toolbarcontrols/comboBoxOne.js"></script>
    <script type="text/javascript" src="../static/js/report/toolbarcontrols/dateTimeOne.js"></script>
    <script type="text/javascript" src="../static/js/report/toolbarcontrols/dateTimeTwo.js"></script>
    <script type="text/javascript" src="../static/js/report/toolbarcontrols/dateTimePickerOne.js"></script>
    <script type="text/javascript" src="../static/js/report/toolbarcontrols/horizontalListBox.js"></script>
    <script type="text/javascript" src="../static/js/report/toolbarcontrols/monthOne.js"></script>
    <script type="text/javascript" src="../static/js/report/toolbarcontrols/halfaYearOne.js"></script>
    <script type="text/javascript" src="../static/js/report/toolbarcontrols/textBox.js"></script>

    <!--epr报表控件-->
    <script type="text/javascript" src="../static/js/report/jmreport.reportControls.js"></script>

    <script type="text/javascript" src="../static/js/report/reportcontrols/gridViewData.js"></script>
    <script type="text/javascript" src="../static/js/report/reportcontrols/advanceGridViewData.js"></script>

    <script type="text/javascript" src="../static/js/report/reportcontrols/eprChart.js"></script>
    <script type="text/javascript" src="../static/js/report/reportcontrols/advanceEprChart.js"></script>

    <script type="text/javascript" src="../static/js/report/reportcontrols/gridSparkLine.js"></script>
    <script type="text/javascript" src="../static/js/report/reportcontrols/itemCompareList.js"></script>
    <script type="text/javascript" src="../static/js/report/reportcontrols/label.js"></script>
    <script type="text/javascript" src="../static/js/report/reportcontrols/imageBox.js"></script>
    <script type="text/javascript" src="../static/js/report/reportcontrols/DataViewDatePick.js"></script>
    <script type="text/javascript" src="../static/js/report/reportcontrols/linkButton.js"></script>
...
**/
        function jmReportMenus(option) {
            ...
            this.option = option;
            /*var ms = this._target.find('> li');
            
            //初始化菜单项
            function iniItems(p, m, l) {
            var item = new oap.menus.prototype.menuitem(p, m, l);        
            var cm = m.find('> ul > li');
            if (cm && cm.length > 0) {
            l++;
            cm.each(function (i, li) {
            iniItems(item, $(li), l);
            });
            }
            }
            //初始化根菜单
            ms.each(function (k, li) {
            iniItems(null, $(li), 0);
            });*/
            this.bind();
        };
        ...
        jmReportMenus.prototype.expend = function (target, exp) {
            ...
            if (ul.length == 0) {
                ...
                if (pageid && !this.option.isFindThisPage) {
                    jmreport.openReportPage(pageid);
                }
                //去除现在的当前菜单样式
        ...
        **/
        ...
        $(function(){
            ...
            jmreport.app = JSON.parse('<%= currentProduction%>');
            jmreport.root = '../';
    ...
    <div id="pagebody">
        <div id="header">
            <div id="header-inner">
                ...
                <div id="logininfo">
                    welcome <span class="user"><%= currentUser.User.NickName %>(<%= currentUser.User.Account %>)</span>
...
<div id="go-top" style="position:fixed;display:none;" title="回到顶部">
    <a href="#" onclick="javascript:window.scrollTo(0,0);return false;">
        <img  src="../static/img/go-up.png")" alt="回到顶部" />
    </a>
